...
public class DateUtil{
    ...
    public static String today(){
        ...
        String dateStr = new SimpleDateFormat(
                "yyyy-dd-MM HH:mm", Locale.ENGLISH).format(
    ...
    public static int dateDiffHours(Date dateFrom, Date dateTo){
        long timeTo = dateTo.getTime(),
             timeFrom = dateFrom.getTime();
        int diff = (int)Math.ceil((timeTo - timeFrom)/(1000*60*60));
        return diff;
    }

    // public static void main(String[] args){
    //     dateDiffHours(DateUtil.stringToDate("2018-03-10 00:00", "yyyy-MM-dd HH:mm"),DateUtil.stringToDate("2018-03-10 02:00", "yyyy-MM-dd HH:mm"));
    //     dateDiffHours(DateUtil.stringToDate("2018-03-10 00:00", "yyyy-MM-dd HH:mm"),DateUtil.stringToDate("2018-03-10 05:00", "yyyy-MM-dd HH:mm"));
    // }
}
